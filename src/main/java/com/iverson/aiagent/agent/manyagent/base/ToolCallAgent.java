package com.iverson.aiagent.agent.manyagent.base;

import cn.hutool.core.collection.CollUtil;
import com.alibaba.cloud.ai.dashscope.chat.DashScopeChatOptions;
import com.iverson.aiagent.agent.manyagent.model.AgentState;
import lombok.Data;
...
public class ToolCallAgent extends ReActAgent {
    ...
    // 工具执行历史记录
    private Map<String, Integer> toolFailureCounts = new HashMap<>();
...
//    }
    ...
    public String act() {
        ...
        try {
            ...
            // 添加失败信息到消息上下文
            getMessageList().add(new org.springframework.ai.chat.messages.AssistantMessage(failureMessage));
            ...
            getMessageList().add(new org.springframework.ai.chat.messages.UserMessage(decisionPrompt));
